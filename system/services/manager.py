...
class ServiceManager:
    ...
    def start_service(
        ...
        return self._run_action("start", service_name)
    ...
    def stop_service(
        ...
        return self._run_action("stop", service_name)
    ...
    def restart_service(
        ...
        return self._run_action("restart", service_name)
    ...
    def reload_service(
        ...
        return self._run_action("reload", service_name)
    ...
    def enable_service(
        ...
        return self._run_action("enable", service_name)
    ...
    def disable_service(
        ...
        return self._run_action("disable", service_name)
